 ...
 */
export default function MapViewWrapper({ onOpenPlace, user, onBack, openNearby }) {
  useEffect(() => {
    // Hide nav bar
  ...
  return (
    ...
    >
      <PlacesMapboxView onOpenPlace={onOpenPlace} user={user} onBack={onBack} openNearby={openNearby} />
    </motion.div>
  );
}