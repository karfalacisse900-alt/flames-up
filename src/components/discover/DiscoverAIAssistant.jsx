      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="fixed bottom-24 right-4 z-40 flex items-center gap-2 px-4 py-3 rounded-full text-sm font-semibold border-2 border-white"
            style={{ backgroundColor: "var(--accent-primary)", color: "#fff", boxShadow: "0 4px 24px rgba(60,110,90,0.55)" }}
          >
