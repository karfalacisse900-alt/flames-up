  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-end"
      ...
      <motion.div
        ...
        style={{ backgroundColor: "var(--bg-card)", borderRadius: "28px 28px 0 0", height: "80vh", boxShadow: "0 -8px 48px rgba(0,0,0,0.2)" }}
        onClick={e => e.stopPropagation()}>

        {/* Handle + header */}
        <div className="shrink-0 px-5 pt-3 pb-4" style={{ borderBottom: "1px solid var(--border-light)" }}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="font-bold text-sm leading-tight" style={{ color: "var(--text-primary)", fontFamily: "var(--font-serif)" }}>NYC AI Guide</p>
                <p className="text-xs" style={{ color: "var(--text-hint)" }}>Ask me anything about New York</p>
              </div>
            </div>
          ...
          {loading && (
            <div className="flex justify-start">
              ...
              <div className="px-4 py-3 rounded-2xl flex items-center gap-1.5"
                style={{ backgroundColor: "var(--bg-subtle)", borderRadius: "20px 20px 20px 6px" }}>
