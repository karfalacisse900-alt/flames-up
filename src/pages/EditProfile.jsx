...
export default function EditProfile() {
  ...
  // All fields — null means "not yet edited, use user default"
  ...
  const currentPortfolio = val(portfolio, "portfolio") || val(null, "portfolio_url");
  ...
  const handleSave = async () => {
    ...
    await base44.auth.updateMe({
      ...
      portfolio_url: currentPortfolio,
    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "var(--bg-app)" }}>
      ...
      <div className="px-4 pb-12" style={{ paddingTop: 16 }}>
        ...
        <div className="space-y-4">
          ...
          <FieldInput label="Portfolio" value={currentPortfolio} onChange={setPortfolio} placeholder="https://portfolio.com" />
        </div>
